...
const CustomTooltip = ({ 
  ...
  return (
    <div className="relative pointer-events-none">
      ...
      >
        <div className="text-[10px] mb-1 opacity-70 text-left">{tooltipLabel}:</div>
        <div className="font-semibold text-[12px] text-left">${value?.toLocaleString() || 0}</div>
      </div>
